...
1.  **Innovation Radar (Radar de Innovación):** Visualiza el panorama científico mediante un *Packed Bubble Chart* que mapea temáticas y conceptos clave extraídos de los títulos de las publicaciones. La IA realiza una normalización y síntesis conceptual para identificar tendencias emergentes, clasificándolas según su estado: *novedades* (innovaciones recientes), *en alza* (fuerte crecimiento) o *consolidadas* (estándares establecidos).
